    ...
    Switch ($ReadHost) 
     { 
       ...
       N {write-host  -ForegroundColor Green "`n Default selected.`n"}  
         ...
         $RAMAssigned = $RAM * 1073741824 # "2,147,483,648"
...
Write-host -ForeGroundColor Cyan "`n`nTo modify the default values used by the script, edit the default parameter`nsettings at the top of the script. If you installed the script using `ninstall-script create-testVMs command, the script can be found at `nC:\Program Files\WindowsPowerShell\Scripts.`n"
